    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                ...
                <a class="waves-effect waves-light btn right" href="{{route('site.dieta.refeicoes.adicionar', [$registro->id, $diasemana])}}">Adicionar</a>
            <table>
                <thead>
                <tr>
                    <th>Descrição</th>
                ...
                @foreach($itemdieta as $item)
                    <tr>
                        ...
                        <td>{{$item->horario}}</td>
                        <td>
                            <a class="waves-effect waves-light btn" href="{{route('site.dieta.editar', $item)}}}">Editar</a>

                            <a class="waves-effect waves-light btn blue darken-1" href="javascript: if(confirm('Deletar esse registro?')){
                    window.location.href='{{route('site.dieta.deletar', $item->id)}}'}">Deletar</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
